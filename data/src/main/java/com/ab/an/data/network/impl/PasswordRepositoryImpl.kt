...
class PasswordRepositoryImpl @Inject constructor(private val apiService: PasswordApiService) :
    ...
    override fun getPasswords(): Flow<Resource<List<PasswordEntity>>> = flow {
    ...
    override fun addPassword(password: PasswordEntity): Flow<Resource<PasswordEntity>> = flow {
    ...
    override fun updatePassword(password: PasswordEntity): Flow<Resource<PasswordEntity>> = flow {
        getResult {
    ...
    override fun deletePassword(id: String): Flow<Resource<PasswordEntity>> = flow {
